...
;(function(__context){
    var module = {
        id : "73355eb2bccf584927933b65d87fb1fa" , 
        filename : "detail.js" ,
        exports : {}
    };
    if( !__context.____MODULES ) { __context.____MODULES = {}; }
    ...
    var detail = __context.____MODULES['f10a06ba5b604f7a8bff33710db0770a'];
  ...
  $.ajax({
    ...
    success: function(reData) {
      ...
      if (reData.ret) {
        ...
        var pages = Math.ceil(len / PAGELEN);
        var page = [];
        $hua.length = 0;
...
$("ul.episode").first().delegate("li", "mouseleave", function() {
  ...
  $this.removeClass("episode-sel");
    ...
    __context.____MODULES[ "73355eb2bccf584927933b65d87fb1fa" ] = module.exports;
})(this);
