...
;(function(__context){
    var module = {
        id : "f11d9e6b1adbeca8d2ce138c9b6da72b" , 
        filename : "jquery.js" ,
        exports : {}
    };
...
if ( typeof module === "object" && module && typeof module.exports === "object" ) {
    ...
    __context.____MODULES[ "f11d9e6b1adbeca8d2ce138c9b6da72b" ] = module.exports;
})(this);


;(function(__context){
    var module = {
        id : "6b3adc3758794f01b7eaf049ac9c1375" , 
        filename : "config.js" ,
        exports : {}
    };
    if( !__context.____MODULES ) { __context.____MODULES = {}; }
	...
	"common": {
		...
		"url_updateSource": "/qunar/seven/comics/replace.do", //更新漫画来源请求地址
		...
		"url_searchTips": "/qunar/seven/comics/match.do",
		"url_addAdmin": "/qunar/seven/comics/addAdmin.do",
		"url_head":"/qunar/seven/comics/getComicsTypeList.do",
		"initFlag": 0,
		"callbackFlag":0
	}
};
    ...
    __context.____MODULES[ "6b3adc3758794f01b7eaf049ac9c1375" ] = module.exports;
})(this);


;(function(__context){
    var module = {
        id : "f10a06ba5b604f7a8bff33710db0770a" , 
        filename : "common.js" ,
        exports : {}
    };
    if( !__context.____MODULES ) { __context.____MODULES = {}; }
    var r = (function( exports , module , global ){
        ...
        __context.____MODULES['f11d9e6b1adbeca8d2ce138c9b6da72b'];
    __context.____MODULES['6b3adc3758794f01b7eaf049ac9c1375'];
    var PARAM = {
        ...
        success: function(reData) {
          if (reData.ret) {
            ...
            for (var i = 0; i < data.length; i++) {
              html = html + ('<li class="c-li"><dl><dt><a href="' + config.common.url_detailComics + data[i].comicsId + '&typeId=' + data[i].typeId + '">' + '<img src="' + data[i].comicsCoverURL + '"  class="c-img"/></a></dt><dd>' + '<p><a href="' + config.common.url_detailComics + data[i].comicsId + '&typeId=' + data[i].typeId + '" class="hua-name">' + data[i].name + '</a></p>' + '<p class="updateCounts">' + data[i].latest + '</p><div class="c-detail"><p>更新于：<span>' + data[i].updateTime + '</span></p>' + '<p>状态：<span>' + data[i].state + '</span></p><p>简介：<span title="' + data[i].briefIntro + '">' + data[i].briefIntro + '</span></p></div></dd></dl></li>');
    ...
    __context.____MODULES[ "f10a06ba5b604f7a8bff33710db0770a" ] = module.exports;
})(this);


;(function(__context){
    var module = {
        id : "17c832ddb7fc9babbe2736ff04418f84" , 
...
jQuery.fn.pagination = function(maxentries, opts){
    ...
    __context.____MODULES[ "17c832ddb7fc9babbe2736ff04418f84" ] = module.exports;
})(this);


;(function(__context){
    var module = {
        id : "cc4f6d4ca16ae0ee63827d9d80e9c281" , 
        filename : "search.js" ,
        exports : {}
    };
    if( !__context.____MODULES ) { __context.____MODULES = {}; }
    ...
    var search = __context.____MODULES['f10a06ba5b604f7a8bff33710db0770a'];
__context.____MODULES['17c832ddb7fc9babbe2736ff04418f84'];
search.get_search(0, 12);

    })( module.exports , module , __context );
    __context.____MODULES[ "cc4f6d4ca16ae0ee63827d9d80e9c281" ] = module.exports;
})(this);
